...
<link rel="stylesheet" href="Cadastro.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="pt"><header class="u-clearfix u-header u-header" id="sec-8d4a"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-5270">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-palette-2-base u-text-1">Cadastro</h1>
        <div class="u-form u-login-control u-form-1">
          <form action="CadastroBD.php" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="username-a30d" class="u-label">Usuário</label>
              <input type="text" placeholder="Insira um nome de Usuário" id="username-a30d" name="usuario" class="u-grey-5 u-input u-input-rectangle u-input-1" required="">
            </div>
            <div class="u-form-group u-form-group-2">
              <label for="text-9fd5" class="u-label">Email</label>
              <input type="text" placeholder="Insira um email válido" id="text-9fd5" name="email" class="u-grey-5 u-input u-input-rectangle u-input-2" required="required">
            </div>
            <div class="u-form-group u-form-password">
              <label for="password-a30d" class="u-label">Senha</label>
              <input type="password" placeholder="Insira uma senha" id="password-a30d" name="senha" class="u-grey-5 u-input u-input-rectangle u-input-3" required="">
            </div>
            <div class="u-form-checkbox u-form-group">
              <input type="checkbox" id="checkbox-a30d" name="remember" value="On">
              <label for="checkbox-a30d" class="u-label">Você concorda com a política e privacidade desse site?</label>
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-hover-palette-2-dark-1 u-palette-2-base u-btn-1">Cadastrar<br>
              </a>
